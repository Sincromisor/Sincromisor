...
| タスク                                                                                                                 | タイトル                                                 | 判定    | 依存                                                        |
| ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ------- | ----------------------------------------------------------- |
| [task-260726211012-pion-phase-2-pipeline-reset-gate-2](./task-260726211012-pion-phase-2-pipeline-reset-gate-2/task.md) | Pion Phase 2のpipeline resetを実装してGate 2を成立させる | ❌ FAIL | `task-260726211007-pion-phase-2-pipeline-websocket-clients` |
