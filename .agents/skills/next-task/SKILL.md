...
name: next-task
description: |-
    依存が解決済みで今すぐ着手できる「次のタスク」を機械抽出し、推奨順に提示して /run-task へ橋渡しする
---

<!-- generated by scripts/gen/genCodex.mjs from .claude/commands/next-task.md — edit the source, then run gen:codex -->
