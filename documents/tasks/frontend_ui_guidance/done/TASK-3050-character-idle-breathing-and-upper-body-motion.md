...
待機中のキャラクターが静止した人形に見えないよう、呼吸、上半身の重心感、肩、胸、背骨、腕、手首の小さな動きを追加する。過剰な演出ではなく、常時見えても邪魔にならない生命感を作る。
...
3. 重心感は呼吸よりさらに遅く、hips/root の位置移動ではなく spine/chest の微小回転で表現する。
...
- 2026-05-10:
    - 上半身前後の揺れがモデルや表示距離によって大きく見えるため、キャラクター表示設定へ `characterMotionScale` を追加し、呼吸・聞き姿勢・AI発話中姿勢の強度を即時調整できるようにした。
