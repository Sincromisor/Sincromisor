...
- 操作導線:
    ...
    - 開発者向け診断は一般設定カテゴリへ混ぜず、右上ツール switcher と `接続` カテゴリ末尾の軽い handoff CTA から同じ右側ツール領域内で切り替える
...
- 主要クラス/モジュールと対応ファイル:
    ...
    - `sincromisor-frontend/src/react/debug/panels/**`
    - `sincromisor-frontend/src/react/debug/components/**`
