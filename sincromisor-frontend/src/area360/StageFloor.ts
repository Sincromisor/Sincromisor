...
export class StageFloor {
    ...
    constructor(scene: Scene) {
        this.scene = scene;
        const floor: Mesh = MeshBuilder.CreatePlane('env.floor', { size: 20 }, this.scene);
    ...
    protected createFloorMaterial(): StandardMaterial {
    ...
    protected createFloorShaderMaterial(): ShaderMaterial {
        ...
        shaderMaterial.setColor4('centerColor', new Color4(0.3, 0.3, 0.3, 1.0)); // 中心の色（黒）
        shaderMaterial.setColor4('edgeColor', new Color4(0.6, 0.6, 0.6, 0.8)); // エッジの色（透明）
        /*
        ...
        */
        ...
        console.log(["floorMaterial", shaderMaterial]);
