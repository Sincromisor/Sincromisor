    ...
    return (
        <div id="debugMenu" className={state.menuOpen ? "is-open" : ""}>
            ...
            >
                ...
                <span className="debugMenuButton__label">ツール</span>
                <span className="debugMenuButton__state">{currentToolLabel}</span>
            </button>
            <div id="debugMenuPanel" role="menu" aria-hidden={!state.menuOpen} aria-label="右側ツール">
                ...
                >
                    <span className="debugMenuPanel__itemText">
                        <span className="debugMenuPanel__itemTitle">設定</span>
                        <span className="debugMenuPanel__itemDescription">会話・表示・接続の調整</span>
                    </span>
                    <span className="debugMenuPanel__itemState" aria-hidden="true">
                        {settingsActive ? "表示中" : "開く"}
                    </span>
                </button>
                <button
                ...
                >
                    <span className="debugMenuPanel__itemText">
                        <span className="debugMenuPanel__itemTitle">開発者向け診断</span>
                        <span className="debugMenuPanel__itemDescription">RTC・音声・状態の確認</span>
                    </span>
                    <span className="debugMenuPanel__itemState" aria-hidden="true">
                        {debugActive ? "表示中" : "開く"}
                    </span>
