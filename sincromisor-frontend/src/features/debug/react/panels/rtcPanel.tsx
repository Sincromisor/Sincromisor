...
export function RtcPanel({ snapshot, isActive }: RtcPanelProps) {
    return (
        ...
        >
            <h3>RTC</h3>
            <RtcMetricGrid snapshot={snapshot} />
            <RtcTrendGraphs snapshot={snapshot} />
        </section>
    );
}

function RtcMetricGrid({ snapshot }: { snapshot: DebugConsoleSnapshot }) {
    return (
        <DebugMetricGrid
            items={[
                {
...
function RtcTrendGraphs({ snapshot }: { snapshot: DebugConsoleSnapshot }) {
    return (
