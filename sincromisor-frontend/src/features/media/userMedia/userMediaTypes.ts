import type { LearnedVadStateReport, LearnedVadTuningConfig } from "../vad/learnedVadWorkerClient";

export type { LearnedVadStateReport, LearnedVadTuningConfig } from "../vad/learnedVadWorkerClient";
