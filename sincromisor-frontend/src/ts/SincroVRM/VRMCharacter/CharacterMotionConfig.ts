...
export const CHARACTER_IDLE_MOTION_CONFIG = {
    ...
    aiSpeaking: {
        attackSeconds: 0.18,
        releaseSeconds: 0.72,
        beatDurationSeconds: 0.48,
        postureBlendScale: 0.72,
        spineLeanRad: MathUtils.degToRad(0.75),
        chestOpenRad: MathUtils.degToRad(1.0),
        chestPitchRad: MathUtils.degToRad(1.0),
        upperChestPitchRad: MathUtils.degToRad(1.35),
        upperChestRollRad: MathUtils.degToRad(0.42),
        hipsFrontShift: 0.004,
        shoulderOpenRad: MathUtils.degToRad(0.9),
        shoulderBeatRad: MathUtils.degToRad(0.55),
        spineBeatYawRad: MathUtils.degToRad(0.42),
        chestBeatPitchRad: MathUtils.degToRad(0.55),
    },
    arms: {
        ...
        speechGestureDurationSeconds: 0.54,
        speechUpperArmLiftRad: MathUtils.degToRad(2.6),
        speechUpperArmOpenRad: MathUtils.degToRad(2.1),
        speechLowerArmFlexRad: MathUtils.degToRad(2.4),
        speechWristRollRad: MathUtils.degToRad(2.0),
    },
    legs: {
